# 🛡️ LLM Guardrails Studio
> Configure input/output validation, prompt injection shields, and SRE safety rules (NeMo/Llama Guard).

[![Studio](https://img.shields.io/badge/Developer_Studio-Live-brightgreen)](https://pradeeptalari14.github.io/portfolio/tools/llm-guardrails/)
...
```
1. Open Studio → https://pradeeptalari14.github.io/portfolio/tools/llm-guardrails/
...
```bash
git clone https://github.com/Pradeeptalari14/tp-llm-guardrails.git
cd tp-llm-guardrails
...
| Resource | Link |
|----------|------|
| Interactive Studio | [Open →](https://pradeeptalari14.github.io/portfolio/tools/llm-guardrails/) |
